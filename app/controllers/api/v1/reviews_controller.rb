class Api::V1::ReviewsController < ApplicationController
  ...
  before_action :authenticate_with_token!, only: [:create, :update, :destroy, :show]
  ...
  def create
    ...
    if review.save
      ...
      json_response("Created review Fail", false, {error: review.errors.full_messages}, :unproccessable_entity)
    end
  end
